...
Source: https://github.com/NREL/buspy/tree/develop/data/example_bus_input
...
def message_gld_input():
    ...
    transfer.add_param(CommonParam(name=NAME,param=PARAM,unit=UNIT,value=abs(random.normal(80.0,10.0))))
...
class TestBus( TestCase ):
    ...
    Usage:
        ...
        nosetests bus_py.py:TestBus.<test_case>
